...
public final class MyLogger implements Serializable {
    private static final long serialVersionUID = 325292835847709L;
     ...
     * @return The custom Logger.
     */
    public static MyLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static MyLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static MyLogger create(final String name, final MessageFactory messageFactory) {
